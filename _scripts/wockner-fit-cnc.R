...
# scp ./_scripts/wockner-fit-cnc.R ./_data/wockner-cleaned.csv lan68@cbsugreischar.biohpc.cornell.edu:/home2/lan68/plasmofit/wock-cnc/
#
# Now on cluster:
#
...
# cd ~/GitHub/Cornell/plasmofit-test
# scp lan68@cbsugreischar.biohpc.cornell.edu:/home2/lan68/plasmofit/wock-cnc/wock-fit-cnc-*.rds ./_data/
#
...
f <- sampling(plasmofit:::stanmodels$archer_fit, data = d, chains = .n_chains,
              iter = 900, warmup = 700,
